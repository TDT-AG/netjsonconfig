                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "reliability": {
                                    "type": "integer",
                                    "title": "Reliability",
                                    "description": "Number of track_ip hosts that must reply for the test to be "
                                                   "considered successful. Ensure there are at least this many "
                                                   "track_ip hosts defined or the interface will always be "
                                                   "considered down",
                                    "default": 1,
                                    "propertyOrder": 5,
                                },
                                ...
                                "recovery_interval": {
                                    ...
                                    "description": "Number of seconds between each test during tearup on recovery"
                                                   " detection",
                                    "propertyOrder": 10,
                                },
                                "keep_failure_interval": {
                                    ...
                                    "description": "In the event of an error, keep the number of seconds between "
                                                   "each test during teardown (failure detection)",
                                    "default": False,
                                    "format": "checkbox",
                                    "propertyOrder": 11,
                                },
                                ...
                                "initial_state": {
                                    "type": "string",
                                    "title": "Initial state",
                                    "description": "If the value is offline, then traffic goes via this interface"
                                                   " only if mwan3track checked the connection first. If the "
                                                   "value is online, then the mwan3track test is not waited for. "
                                                   "The interface is marked as online at once.",
                                    "enum": [
                                        "online",
                                        "offline",
                                    ],
                                ...
                                "size": {
                                    "type": "integer",
                                    "title": "Size",
                                    "description": "Size of ping packets to use in bytes. Only valid if tracking "
                                                   "method is ping.",
                                    "default": 56,
                                    "propertyOrder": 17,
                                },
